...
from worker.confidence import resolve_field
from worker.engines import pick_engine
from worker.engines.scripted import SCRIPTED_ENGINES
from worker.engines.scripted.greenhouse import GreenhouseFillEngine
...
def test_pick_engine_prefers_scripted_and_falls_back_to_agentic():
    from worker.engines.agentic import AgenticFillEngine
