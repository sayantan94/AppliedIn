"""Shared fixtures: moto-backed tables/bucket matching the CDK schema."""
...
def artifacts_bucket(aws):
    boto3.client("s3", region_name="us-east-1").create_bucket(Bucket="appliedin-artifacts")
    return "appliedin-artifacts"
